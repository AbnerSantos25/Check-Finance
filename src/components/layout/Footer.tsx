  ...
  return (
    <footer className="mt-16 border-t border-line-soft bg-bg-deep py-8 px-4 sm:px-6 lg:px-8 text-xs text-slate-400">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <Link to="/" className="tap-target gap-2 text-slate-400 hover:text-slate-200 transition-colors">
      ...
      <div className="max-w-7xl mx-auto mt-4 pt-4 border-t border-white/5 text-[12px] sm:text-[10px] text-slate-400 text-center sm:text-left flex flex-col sm:flex-row justify-between items-center gap-2">
        ...
        <a
          ...
          className="tap-target gap-2 hover:text-slate-200 transition-colors"
        >
